...
export default function ContactoPage() {
  ...
  const contactItems = [
    { label: tCommon("email"), value: "info@mepcompliance.com", href: "mailto:info@mepcompliance.com", icon: contactIconEmail },
    { label: tCommon("phone"), value: "+54 11 4916-9760", href: "tel:+541149169760", icon: contactIconPhone },
  ];
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#f8f8f6" }}>
      ...
      <section
        ...
        style={{ backgroundColor: "#f8f8f6", borderBottom: "1px solid rgba(26, 26, 26, 0.08)" }}
      >
        <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
            <div className="lg:col-span-5">
              <h2
                ...
                style={{ fontFamily: "var(--font-rhymes)", fontWeight: 600, color: "#1a1a1a" }}
              >
                {t("contactData")}
              </h2>
              <p
                className="text-sm mb-8"
                style={{ fontFamily: "var(--font-monument)", color: "rgba(26, 26, 26, 0.7)", lineHeight: 1.65 }}
              >
                {t("contactIntro")}
              </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  <label
                    ...
                    style={{ fontFamily: "var(--font-monument)", color: "rgba(26, 26, 26, 0.6)" }}
                  >
                    {t("name")}
                  </label>
                  <input
                    ...
                    style={{ fontFamily: "var(--font-monument)", color: "#1a1a1a", fontSize: "15px" }}
                ...
                <div className="pt-2 space-y-3">
                  ...
                  <div className="min-h-[20px]">
                    {submitStatus === "success" && (
                      <p className="text-xs text-emerald-700" style={{ fontFamily: "var(--font-monument)" }}>
                        {t("success")}
                      </p>
                    )}
                    {submitStatus === "error" && (
                      <p className="text-xs text-red-600" style={{ fontFamily: "var(--font-monument)" }}>
                        {t("error")}
                      </p>
                    )}
                  </div>
