...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: t("title"),
    description: locale === "en" ? "Cookie policy of MEP Compliance website." : "Política de cookies del sitio web de MEP Compliance.",
    openGraph: { title: `${t("title")} | MEP Compliance`, description: locale === "en" ? "Use of cookies on the site." : "Uso de cookies en el sitio." },
      ...
      >
        <div className="mx-auto max-w-4xl px-6 sm:px-8 lg:px-12">
          <p className="text-zinc-700 leading-relaxed" style={{ fontFamily: "var(--font-inter)" }}>
            {locale === "en"
              ? "This site may use cookies to improve your experience. For more information, contact info@mepcompliance.com."
              : "Este sitio puede utilizar cookies para mejorar su experiencia. Para más información, contactenos en info@mepcompliance.com."}
          </p>
        </div>
      </section>
      <Footer />
