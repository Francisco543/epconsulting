...
export const metadata: Metadata = {
  ...
  description:
    "Política de cookies del sitio web de MEP Compliance. Uso de cookies, tipos y gestión de preferencias.",
  openGraph: {
    title: "Política de Cookies | MEP Compliance",
            ...
            >
              <section>
                ...
                <p>
                  ...
                  su dispositivo (ordenador, tablet, smartphone) cuando visita
                  un sitio web. Las cookies permiten que el sitio web recuerde
                  sus acciones y preferencias durante un período de tiempo, por
                  lo que no tiene que volver a configurarlas cada vez que
              ...
              <section>
                ...
                <p>
                  ...
                  web y no se pueden desactivar. Permiten funciones básicas como
                  la navegación por la página y el acceso a áreas seguras del
                  sitio web.
                </p>
                <ul className="list-disc pl-6 space-y-2 mt-4">
                  <li>
                    <strong>Finalidad:</strong> Garantizar el correcto
                    funcionamiento del sitio web
                  </li>
                  <li>
                    <strong>Duración:</strong> Sesión o persistentes
                  </li>
                  <li>
                    <strong>Gestión:</strong> No requieren consentimiento
                  </li>
                </ul>
                ...
                <p>
                  ...
                  interactúan con nuestro sitio web, proporcionándonos
                  información sobre las áreas visitadas, el tiempo de
                  permanencia y cualquier problema encontrado.
                </p>
                <ul className="list-disc pl-6 space-y-2 mt-4">
                  <li>
                    <strong>Finalidad:</strong> Análisis estadístico del uso del
                    sitio web
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Gestión:</strong> Requieren consentimiento
                  </li>
                </ul>
                ...
                <p>
                  ...
                  que cambia la forma en que el sitio se comporta o se ve, como
                  su idioma preferido o la región en la que se encuentra.
                </p>
                <ul className="list-disc pl-6 space-y-2 mt-4">
                  <li>
                    <strong>Finalidad:</strong> Recordar sus preferencias y
                    configuraciones
                  </li>
                  <li>
                    <strong>Duración:</strong> Persistentes (hasta 1 año)
                  </li>
                  <li>
                    <strong>Gestión:</strong> Requieren consentimiento
                  </li>
              ...
              <section>
                ...
                <p>
                  Nuestro sitio web puede utilizar servicios de terceros que
                  instalan cookies en su dispositivo. Estos servicios incluyen:
                </p>
                <ul className="list-disc pl-6 space-y-2 mt-4">
                  <li>
                  ...
                  <li>
                    <strong>Redes Sociales:</strong> Para compartir contenido en
                    redes sociales
                  </li>
                </ul>
                <p className="mt-4">
                  Estas cookies están sujetas a las políticas de privacidad de
              ...
              <section>
                ...
                <p>
                  ...
                  preferencias de cookies. Puede configurar su navegador para
                  rechazar cookies o para que le avise cuando un sitio web
                  intente colocar una cookie en su dispositivo.
                </p>
                <p className="mt-4">
                ...
                <p>
                  Puede gestionar sus preferencias de cookies a través del panel
                  de configuración que aparece en su primera visita al sitio web
                  o accediendo a la configuración de cookies en cualquier
                  momento.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  ...
                  sitio web pueden no estar disponibles o no funcionar
                  correctamente. Las cookies técnicas son necesarias para el
              ...
              <section>
                ...
                <p>
                  ...
                  otras razones operativas, legales o regulatorias. Le
